...
public class BinPage {
    ...
    public void test2() 
    {
    	...
    	WebElement admin =driver.findElement(By.cssSelector("#menu > li:nth-child(4) > a > i"));
    ...
    {
     // WebElement bin =
      driver.findElement(By.xpath("//*[@id=\"menu\"]/li[4]/ul/li[5]/a")).click();
      // Actions actt=new Actions(driver);
   	//  actt.moveToElement(bin).click().perform();
