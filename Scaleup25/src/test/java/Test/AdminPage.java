...
public class AdminPage {
	...
	{	
		...
		driver.findElement(By.className("btn-login-custom")).click();
	}	
    ...
    //	act.moveToElement(admin).click().perform();
    	...
    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    	WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div/body/div/div[2]/div/ul/li[4]/a")));
    	element.click();

    }
    
	@Test(priority=4)                     //leadsettings//
	public void test3()
	{
		driver.findElement(By.xpath("//a[normalize-space()='Leads settings']")).click();		
	}
	@Test(priority=5)
	public void test4()
	                                                //lead source//
	{
	   driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		...
		driver.findElement(By.xpath("//*[@id=\"main-wrapper\"]/div[3]/div/div/div/div/div/div/div/div/div[2]/div/div/div/div[1]/div/input")).sendKeys("google");
		driver.findElement(By.xpath("//*[@id=\"main-wrapper\"]/div[3]/div/div/div/div/div/div/div/div/div[2]/div/div/div/div[1]/span/button")).click();
		driver.findElement(By.cssSelector("button[aria-label='Close']")).click();
		
	}
	@Test(priority=6)
	public void test5()                         //leadstage//
	{
		driver.findElement(By.xpath("//a[normalize-space()='Leads Stage']")).click();
	}
